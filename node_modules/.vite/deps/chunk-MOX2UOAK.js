...
var SvgIcon = React4.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsxs)(SvgIconRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime5.jsx)("title", {
...
//# sourceMappingURL=chunk-MOX2UOAK.js.map
