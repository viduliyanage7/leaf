...
var require_breakpoints = __commonJS({
  "node_modules/@mui/system/breakpoints.js"(exports) {
    ...
    function mergeBreakpointsInOrder2(breakpointsInput, ...styles) {
      ...
      const mergedOutput = [emptyBreakpoints, ...styles].reduce((prev, next2) => (0, _deepmerge.default)(prev, next2), {});
...
function mergeBreakpointsInOrder(breakpointsInput, ...styles) {
  ...
  const mergedOutput = [emptyBreakpoints, ...styles].reduce((prev, next2) => deepmerge(prev, next2), {});
...
@mui/styled-engine/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-X2P6GLPJ.js.map
