...
const Suppliernew = (props) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post('http://web.liyontatea.com/api/agent_get', { phnumber: '' });
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('http://web.liyontatea.com/api/add_new_supplier', newData);
